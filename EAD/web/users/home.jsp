...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/moviecad.css">
        <link href="../css/star1.css" rel="stylesheet">
        <title>GmDb</title>
    </head>
    <body>
        
        <%
            String name = String.valueOf(session.getAttribute("name_in"));
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    <li class="active"><a href="#">Hi, <%=name%></a></li>
                </ul>
...
//                                            int starval = (int) avr;
                        ...
                        <a href="#"><div class="views2"><%=mv.getPrice()%> <span class="glyphicon glyphicon-usd"></span> </div></a>         
                        <button type="submit" class="views3" name="action" value="price" >For Purchase</button>
